const dzikir = {
  pagi: [
    {
      id: 1,
      lafadz: "بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ",
      artinya:
    ...
    },
    {
      ...
      artinya:
        "Dialah Allah, Yang Maha Esa. Allah adalah ilah yang bergantung kepada-Nya segala urusan. Dia tidak beranak dan tiada pula diperanakkan, dan tidak ada seorang pun yang setara dengan Dia.",
    },
    {
      id: 4,
      lafadz:
    ...
    },
    {
      ...
      artinya:
        "Dengan nama Allah yang jika disebut, segala sesuatu di bumi dan langit tidak akan berbahaya, Dialah Yang Maha Mendengar lagi Maha Mengetahu",
    },
    {
      id: 13,
      lafadz:
      ...
      artinya:
        "Wahai Tuhan Yang Maha Hidup, wahai Tuhan Yang berdiri Sendiri, dengan rahmat-Mu aku meminta pertolongan, perbaikilah segala urusanku dan jangan diserahkan kepadaku sekalipun sekejap mata",
    },
    {
      id: 14,
      lafadz:
    ...
    },
    {
      ...
      artinya:
        "Mahasuci Allah, aku memuji-Nya sebanyak makhluk-Nya, sejauh kerelaan-Nya, seberat timbangan arsy-Nya dan sebanyak tinta kalimat-Nya",
    },
    {
      id: 17,
      lafadz:
      ...
      artinya:
        "Ya Allah, sungguh aku memohon kepada-Mu ilmu yang manfaat, rezki yang baik dan amal yang diterima",
    },
    {
      //dibaca 100 kali
      id: 18,
...
(function dataHtml(params) {
  let pagi = document.querySelector("div.isi#pagi");
  let petang = document.querySelector("div.isi#petang");
  ...
  dzikir.pagi.forEach((el) => {
    ...
    pagi.appendChild(wrapper);
  });

  dzikir.petang.forEach((el) => {
    const { lafadz, artinya } = el;
